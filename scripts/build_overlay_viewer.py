...
from studio.rasterize import FREE, OCCUPIED, load_occupancy_grid_pgm
from studio.trajectory import Pose, generate_lawnmower_trajectory, load_trajectory
...
def render_map_png_base64(occ) -> str:
    import matplotlib
...
def main() -> None:
    ...
    map_b64 = render_map_png_base64(occ)
